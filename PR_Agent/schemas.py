...
from PR_Agent.models import Decision, ReviewStatus, TaskStatus
...
class CodingDecisionCreate(BaseModel):
    approved_paths: list[str] = Field(default_factory=list, max_length=25)
