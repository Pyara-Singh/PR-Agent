...
from proofmerge.worker import run_worker
...
def main() -> None:
    parser = argparse.ArgumentParser(description="ProofMerge control plane")
    ...
    if args.command == "serve":
        uvicorn.run("proofmerge.api:app", host=args.host, port=args.port, reload=args.reload)
